...
const Mute = ({ func, audio }) => {
	...
	return (
		<div className="absolute z-20 mt-[38%]  pr-20 pl-12 text-white  right-0 cursor-pointer">
			<div className="outline outline-2 outline-offset-2 rounded-full p-2 hover:opacity-100 opacity-70 flex justify-center">
				<button onClick={toggleMute}>
					{audio === "mute=0" ? unMuteSvg : muteSvg}
				</button>
			</div>
		</div>
...
export default Mute;
// outline outline-2 outline-offset-2 rounded-full p-2
